...
impl Chip8System {
    ...
    fn execute_opcode(&mut self) {
        ...
        match op {
            ...
            (0x0C, vx, n1, n2) => {
                self.v[vx as usize] = thread_rng().gen_range(0..255) as u8 & ((n1 << 4) + n2);
            }
            ...
            (0x0D, vx, vy, n) => {
                ...
                for byte in 0..n {
                    ...
                    for bit in 0..8 {
                        let x = (self.v[vx as usize] as usize + bit) % CHIP8_WIDTH;
        ...
        for y in 0..CHIP8_HEIGHT {
            for x in 0..CHIP8_WIDTH {
                ctx.set(
                    x,
                    y,
                    if self.vram[x][y] { BLACK } else { WHITE },
                    BLACK,
                    to_cp437('█'),
                );
            }
...
fn main() -> BError {
    ...
    let mut rom_file = File::open("D:\\User\\Downloads\\chip8\\test_opcode.ch8").unwrap();
    rom_file
